...
exports.updateEstatusUsuarios = exports.deleteUsuario = exports.putUsuario = exports.postUsuario = exports.getUsuarioById = exports.getUsuariosIdCorporacion3 = exports.getUsuariosIdCorporacion2 = exports.getUsuariosIdCorporacion = exports.getUsuariosIdNombre = exports.getUsuarios = void 0;
...
const getUsuariosIdCorporacion3 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _e;
    const { id } = req.params;
    const usuarios = yield ((_e = usuarios_model_1.default.sequelize) === null || _e === void 0 ? void 0 : _e.query(`SELECT usuarios.idusuarios AS idSup, usuarios.nombre AS nombreSup, usuarios.apellido_pat AS appatSup, usuarios.apellido_mat AS apmatSup,
		usuarios.fk_puesto, puestos.idpuesto, puestos.nombre AS nombrePuesto, puestos.fk_corporacion, corporaciones.idcorporaciones, corporaciones.nombreCorporacion,
		usuarios.cuip, usuarios.clave_elector, usuarios.imagen_ine, usuarios.imagen_cuip, usuarios.titulo, usuarios.estatus, usuarios.createdAt, usuarios.updatedAt
    FROM usuarios
    LEFT JOIN puestos ON usuarios.fk_puesto = puestos.idpuesto
