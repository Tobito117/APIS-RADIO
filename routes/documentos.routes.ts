...
import { getDocumentos, getDocumentosById, postDocumentos, putDocumentos, deleteDocumentos, updateEstatusDocumentos, mostrarImange, postDocumentosIne, postDocumentosCuip, getDocumentosTipoIne, getDocumentosTipoCuip, postDocumentosEvidencia } from "../controllers/documentos.controller";
...
router.post('/evidencia', validarArchivoSubir, postDocumentosEvidencia);
